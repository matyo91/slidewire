<x-slidewire::deck theme="black" transition="fade" show-progress="true" show-controls="true" show-fullscreen-button="true">
    ...
    <x-slidewire::slide class="dw-slide">
        <section class="dw-wrap">
            ...
            <p class="dw-lead">Structured metadata: modalities, limits, pricing tiers, reasoning flags.</p>
    ...
    {{-- 04 - models.dev site (iframe) --}}
    <x-slidewire::slide class="dw-slide">
        <section class="dw-wrap dw-wrap--top">
            <p class="dw-kicker">Live - models.dev</p>
            <h2 class="dw-heading-slide">models.dev</h2>
            <p class="dw-lead">Public catalog in the browser. Some sites block iframes; if the frame is blank, open the URL in a new tab.</p>
            <x-nolife-demo-frame url="https://models.dev/" title="models.dev" class="mt-4" />
        </section>
        <footer class="dw-footer"><span>04 / models.dev · site</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        <section class="dw-wrap">
            ...
            <p class="dw-lead">Filter, sort by $/M, context, capabilities.</p>
        </section>
        <footer class="dw-footer"><span>05 / modles</span></footer>
    </x-slidewire::slide>

    {{-- 06 - modles site (iframe) --}}
    <x-slidewire::slide class="dw-slide">
        <section class="dw-wrap dw-wrap--top">
            <p class="dw-kicker">Live - modles</p>
            <h2 class="dw-heading-slide">modles</h2>
            <p class="dw-lead">Local comparator lab for catalog rows (this deck expects it on port 8001).</p>
            <x-nolife-demo-frame url="{{ $MODLES }}/" title="modles" class="mt-4" />
        </section>
        <footer class="dw-footer"><span>06 / modles · site</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>07 / analogy</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>08 / ollama</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>09 / demo · catalog</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>10 / demo · ollama</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>11 / nolife stack</span></footer>
    </x-slidewire::slide>
...
flowchart TB
  ...
  SE -.-> EX
        ...
        <footer class="dw-footer"><span>12 / architecture</span></footer>
    </x-slidewire::slide>
            ...
            <pre class="mt-8 dw-code">interface LocalModelRuntimeInterface
{
    ...
    public function generate(GeneratePromptCommand $command): ModelInferenceResult;
        ...
        <footer class="dw-footer"><span>13 / port</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>14 / demo · compare</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>15 / compare concepts</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>16 / demo · benchmark</span></footer>
    </x-slidewire::slide>
...
flowchart LR
  ...
  T --> X[Matrix + exports]
        ...
        <footer class="dw-footer"><span>17 / benchmark flow</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>18 / demo · exports</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>19 / observability</span></footer>
    </x-slidewire::slide>

    {{-- 20 - Kronk positioning --}}
    <x-slidewire::slide class="dw-slide">
        <section class="dw-wrap">
        ...
        <footer class="dw-footer"><span>20 / kronk</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>21 / embedded primitives</span></footer>
    </x-slidewire::slide>
...
flowchart LR
  ...
  E --> O[Observability plane]
        ...
        <footer class="dw-footer"><span>22 / pipeline</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>23 / future</span></footer>
    </x-slidewire::slide>
    ...
    <x-slidewire::slide class="dw-slide">
        ...
        <footer class="dw-footer"><span>24 / outro</span><img src="/darkwood/logos/dw512x512-light.png" alt="Darkwood"></footer>
    </x-slidewire::slide>
</x-slidewire::deck>
